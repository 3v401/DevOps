...
# Initialize the OWASP Dependency-Check database
/opt/owasp/dependency-check/bin/dependency-check.sh --updateonly
sudo chown -R ubuntu:ubuntu /opt/owasp/dependency-check
